...
public class CircleImageView extends ImageView{
    ...
    private void getAttrsValues(Context context, AttributeSet attrs, int defStyleAttr){
...
//               mShaderMatrix.setScale(scale, scale);
        ...
        dx = (mDrawableRect.width() - mBitmapWidth * scalex) * 0.5f;
        dy = (mDrawableRect.height() - mBitmapHeight * scaley) * 0.5f;
