...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	@Override
	public final void onRefreshComplete(boolean isRset,boolean isSuccess) {
	...
	protected void onReset() {
		...
		if(isRefreshSuccess){
			mHeaderLayout.reset(isReset,isRefreshSuccess);
			mFooterLayout.reset(isReset,isRefreshSuccess);
		}else{
			mHeaderLayout.reset(isReset,isRefreshSuccess);
			mFooterLayout.reset(isReset,isRefreshSuccess);
		}
		...
		smoothScrollTo(0, 2000, 0, new OnSmoothScrollFinishedListener() {
			@Override
			public void onSmoothScrollFinished() {
				mHeaderLayout.reset(true,isRefreshSuccess);
				mFooterLayout.reset(true,isRefreshSuccess);
			}
		});
	}
