...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    //回滚handler
    private MScrollBackHandler updateHandler;

    //刷新结果停留handler
    private MResultHandler resultHandler;

    //刷新结果停留时间
    private static final long keepTime = 2000;
    ...
    private void initView(Context context) {
        updateHandler = new MScrollBackHandler(context);
        resultHandler = new MResultHandler(context);
     ...
     * 执行自动回滚的handler
     */
    private class MScrollBackHandler extends BaseHandler<Context> {

        public MScrollBackHandler(Context reference) {
            super(reference);
        }
    ...
    public void refreshFinish(int refreshResult) {
         ...
         */
        // 刷新结果停留n秒
        resultHandler.sendEmptyMessageDelayed(0, keepTime);
    }

    /**
     * 刷新结果停留handler
     */
    private class MResultHandler extends BaseHandler<Context> {

        public MResultHandler(Context reference) {
            super(reference);
        }
